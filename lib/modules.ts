...
export const MODULES: PersanaModule[] = [
  ...
  // ───────────────────────────── Exames & dados ─────────────────────────────
  {
    ...
    grupo: "Exames & dados",
    resumo:
      "Structured-first (API>QR>template>OCR) com proveniência; extração por IA de fallback, histórico longitudinal, LOINC + 604 marcadores com faixa funcional.",
    status: "live",
    backend: "modules/exames.py · platform/exames_ingest.py · migration 038",
    entregue: [
      ...
      "Histórico longitudinal por analito · LOINC 2.82 + 604 marcadores (90%)",
